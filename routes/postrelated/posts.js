...
router.get('/:id', async (req, res) =>{
  ...
  let queryString = `SELECT tb1.*, tb2.firstname, tb2.surname FROM Post tb1 JOIN user tb2 on tb1.seller = tb2.iduser JOIN PostImage tb3 ON tb3.imageID = tb1.imageId WHERE idposts=${id};`;
